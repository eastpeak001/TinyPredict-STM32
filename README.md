...
本项目已完成 STM32CubeIDE 工程搭建、MPU6050 读取、USART1 调试输出、启动校准状态、高通振动检测算法、风扇振动测试、Python CSV 记录、OLED 本地显示实物验证，并已进入 V0.4B STM32F103C8T6 最小系统 PCB 阶段。
